            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-start">
                        <h4>Laporan Pengeluaran Lain-Lain</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-around">
                                                    ...
                                                    <button class="btn btn-warning" type="button" onclick="window.location.href='<?php echo base_url('admin/Modal/edit_modal/' . $dt_modal['id_modal'] . '/' . $tanggal) . '/3' ?>'">
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header ml-3">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Pengeluaran Lain-Lain</h5>
            ...
            <div class="modal-body ml-3">
                <form action="<?php echo base_url('admin/Modal/tambah_data_modal') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input_fields_wrap">
                        <input type="hidden" name="jenis_pengeluaran" value="3">
                        <div class="row">
                            <div class="col-3">
...
<script type="text/javascript">
    ...
    function filter() {
        var tanggal = document.getElementById('tanggal_filter').value;
        if (tanggal != '') {
            window.location = "<?php echo base_url('admin/Modal/lain_lain/') ?>" + tanggal;
        } else {
