            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-start">
                        <h4>Laporan Pengeluaran Akomodasi</h4>
                    ...
                    <div class="card-body">
                        <div class="form-group d-flex align-items-center">
                            ...
                            <!-- ekspor pdf -->
                            <a href="<?php echo base_url('admin/Cetak_pdf/cetak_modal_pdf/' . $tanggal . '/2') ?>" target="_blank" class="btn btn-warning ml-3"><i class="fas fa-file mr-2"></i>Export pdf</a>
                            <!-- tambah data -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-around">
                                                    ...
                                                    <button class="btn btn-warning" type="button" onclick="window.location.href='<?php echo base_url('admin/Modal/edit_modal/' . $dt_modal['id_modal'] . '/' . $tanggal) . '/2' ?>'">
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header ml-3">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Pengeluaran Akomodasi</h5>
            ...
            <div class="modal-body ml-3">
                <form action="<?php echo base_url('admin/Modal/tambah_data_modal') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input_fields_wrap">
                        <input type="hidden" name="jenis_pengeluaran" value="2">
                        <div class="row">
                            <div class="col-3">
...
<script type="text/javascript">
    ...
    function filter() {
        var tanggal = document.getElementById('tanggal_filter').value;
        if (tanggal != '') {
            window.location = "<?php echo base_url('admin/Modal/akomodasi/') ?>" + tanggal;
        } else {
